...
struct _GstStreamsManagerClass
{
  ...
  gchar*      (*fragment_name)   (GstStreamsManager *self,
                                  GstPad *pad, guint index);

  gchar*      (*headers_name)    (GstStreamsManager *self,
                                  GstPad *pad);
...
gchar*           gst_streams_manager_fragment_name        (GstStreamsManager * man,
                                                           GstPad * pad, guint index);

gchar*           gst_streams_manager_headers_name         (GstStreamsManager * man,
                                                           GstPad * pad);
