...
GST_DEBUG_CATEGORY (gst_dash_sink_debug);
#define GST_CAT_DEFAULT gst_dash_sink_debug

G_DEFINE_TYPE_WITH_CODE (GstDashSink, gst_dash_sink,
    GST_TYPE_BASE_ADAPTIVE_SINK, GST_DEBUG_CATEGORY_INIT (gst_dash_sink_debug,
        "dashsink", 0, "dashsink element");
    );
